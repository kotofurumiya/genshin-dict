...
export default {
  ...
  items: [
    ...
    { hiragana: 'かたゆん', word: 'カタユン', note: '知恵の殿堂の図書館司書' },
    { hiragana: 'ざははでぃ', word: 'ザハハディ', note: '妙論派の学者' },
    { hiragana: 'じゅらいせん', word: 'ジュライセン', note: '素論派の学者' },
    { hiragana: 'なふぃす', word: 'ナフィス', note: '生論派の賢者' },
    { hiragana: 'ばらーずりー', word: 'バラーズリー', note: '因論派の賢者' },
    { hiragana: 'ふぃるなす', word: 'フィルナス', note: '妙論派の賢者' },
    { hiragana: 'あるきんでぃ', word: 'アルキンディ', note: '素論派の賢者' },
    { hiragana: 'るしゅど', word: 'ルシュド', note: '知論派の賢者' },
    { hiragana: 'しゃきーる', word: 'シャキール', note: '明論派の賢者' },
    { hiragana: 'とーと', word: 'トート', note: 'キングデシェレトの七柱の1人' },
    { hiragana: 'そべく', word: 'ソベク', note: 'キングデシェレトの七柱の1人' },
    { hiragana: 'へりしゃふ', word: 'ヘリシャフ', note: 'キングデシェレトの七柱の1人' },
    { hiragana: 'しぇせぷあんく', word: 'シェセプアンク', note: 'キングデシェレトの七柱の1人' },
    { hiragana: 'べんぬ', word: 'ベンヌ', note: 'キングデシェレトの七柱の1人' },
